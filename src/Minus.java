...
/**
 * Minus extends BinaryExpression and implements Expression. it indicates the subtraction of 2 expressions.
 *
 * @ 05.05.18
 * @ author: Idan Twito
 */
public class Minus extends BinaryExpression implements Expression {
     ...
     */
    public Minus(String var, Expression leftExpression) {
     ...
     */
    public Minus(String var1, double num) {
        super(var1, num);
    }
     ...
     */
    public Minus(double num, String var1) {
        super(num, var1);
    }
     ...
     * @param leftExpression second Expression
     */
    public Minus(double num1, Expression leftExpression) {
     ...
     */
    public Minus(Expression leftExpression, double num1) {
     ...
     * @return the result of substracion of these expressions
    ...
    public Expression simplify() {
        ...
        try {
            return new Num(new Minus(leftExp, rightExp).evaluate());
        } catch (Exception exception) {
            //0-X = -X
            if (leftExp.toString().equals("0.0")) {
                return new Neg(rightExp);
            }
            //X-0 = X
